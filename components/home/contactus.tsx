...
export default function ContactUs() {
  return (
    <div className="w-full  pt-16 pb-16 border-t border-gray-400 bg-primary/5">
      <div className=" max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-3 max-w-lg mx-auto text-neutral-200 mt-12">
          ...
          <div className="flex items-center justify-center gap-2 bg-neutral-50 ring-1 ring-gray-400 p-2 min-w-52 text-gray-800 rounded-lg cursor-pointer">
