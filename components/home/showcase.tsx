...
export default function Showcase() {
  return (
    <div className="w-full bg-primary">
      <div className="w-full h-full px-2 py-10 lg:py-16 lg:px-8 bg-gradient-to-b from-gray-900 to-transparent">
        <div className="flex flex-col lg:flex-row-reverse items-center gap-8 mx-auto max-w-6xl pb-6 md:pb-12 lg:pt-18">
          ...
          <div className="w-[100%] md:w-[50%]">
            <div className="space-y-9">
              <p
                className={` ${montserrat.className}  font-bold text-gray-200`}
        ...
        <div className="flex justify-center mt-4 md:mt-6 max-w-3xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center gap-x-6 gap-y-4">
            ...
            <a
              href="#"
              className="font-sans text-md font-semibold leading-6 text-neutral-50"
            >
