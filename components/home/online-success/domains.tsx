      ...
      <div className="mt-4 grid grid-cols-1 gap-x-12 gap-y-6 lg:grid-cols-12">
        ...
        <div className="pt-1 text-neutral-300 lg:col-span-7">
          ...
          <p className="hidden font-sans text-base leading-relaxed text-gray-300 md:block">
            ...
            simplify every step — giving you full control without the hassle.
          </p>
          ...
          <div className="mt-6 space-y-2 font-sans text-md">
            ...
            <div className="flex items-center gap-3">
              <Check className="h-auto w-2.5 flex-shrink-0 text-gray-400" />
              <span className="text-gray-300/85">Advanced DNS management</span>
            </div>
            <div className="flex items-center gap-3">
              <Check className="h-auto w-2.5 flex-shrink-0 text-gray-400" />
              <span className="text-gray-300/85">
        ...
        <div className="relative lg:col-span-5">
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-gray-900 to-blue-400/25 p-2 backdrop-blur-md lg:p-4">
            {/* Domain illustration */}
