...
export default function PricingPlans({
  ...
  return (
    <div className="x-padding w-full">
      <div
        className="relative isolate mx-auto max-w-7xl overflow-hidden py-16"
        id="pricing-plans"
      >
        <div
          aria-hidden="true"
        ...
        <div
          className={`mx-auto mt-12 grid max-w-5xl grid-cols-1 items-center gap-x-8 gap-y-8 px-1 md:grid-cols-2 ${display || ""} `}
        >
          {plans.map((plan) => (
            <div
              key={plan.id}
            ...
            >
              ...
              <p
                className={classNames(
                  "mt-6 flex items-center gap-x-2 rounded-3xl text-[0.82rem] font-medium text-secondary",
                )}
              >
                <span>
