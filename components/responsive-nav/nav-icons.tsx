...
export const WebMailIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const LinuxIcon = ({ size }: { size: string }) => {
  return (
    <div className={size}>
      <img src="/svg/navbar/linux-icon.svg" alt="Linux icon"></img>
    </div>
  );
};
...
export const WindowsIcon = ({ size }: { size: string }) => {
  return (
    <div className={size}>
      <img src="/svg/navbar/windows-icon.svg" alt="windows icon"></img>
    </div>
  );
};
...
export const CpanelIcon = ({ size }: { size: string }) => {
  return (
    <div className={` ${size} flex items-center justify-center`}>
      <img src="/svg/navbar/cPanel-icon.svg" alt="cPanel icon"></img>
    </div>
  );
};
...
export const DomainIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const InfoIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const CreditCardIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const NetworkSquareIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const BookIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const LoginIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const RegisterIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const OpenTicketIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const TicketsIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const KnowledgebaseIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const ChatIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const MailPlusIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const InboxSolidIcon = ({ size }: { size: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
