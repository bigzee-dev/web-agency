...
export default function Form() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="w-full flex flex-col sm:flex-row justify-between items-center mt-2 gap-4">
        ...
        <div
          ...
          data-theme="dark"
        >
          {/* Optionally, show a loading state or placeholder here if turnstile is slow to appear */}
          {!widgetIdRef.current &&
            !status.error?.includes("CAPTCHA service could not be loaded") && (
              <p className="text-xs text-neutral-400">Loading CAPTCHA...</p>
            )}
        </div>
