...
export default function VpsFeatures() {
  return (
    <div className="pb-12">
      <div className="mx-auto grid h-[27rem] max-w-6xl grid-cols-12 gap-x-14 border border-gray-400 bg-[#faf9f5] p-8">
        ...
        <div className="col-span-6 flex flex-col justify-center gap-y-7">
          ...
          <ul className="mx-auto grid h-48 w-[90%] list-inside grid-cols-2 gap-x-1 gap-y-1 self-center font-sans text-base text-gray-800 md:gap-x-0">
