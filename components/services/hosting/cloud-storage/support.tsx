...
export default function CloudStorageSupport() {
  return (
    <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-x-12 gap-y-16 rounded-none bg-gradient-to-tr from-gray-900 via-gray-900 to-primary px-8 py-12 md:grid-cols-12 md:rounded-3xl md:px-20 md:pr-8">
