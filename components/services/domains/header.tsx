...
export default function Header() {
  return (
    <div className="relative w-full bg-gray-900">
      <div className="x-padding inset-0 w-full bg-gradient-to-r from-transparent via-secondary/60 to-secondary pb-2 pt-16">
        <div className="mx-auto max-w-7xl">
          <div className="max-full grid grid-cols-1 gap-10 md:grid-cols-12">
