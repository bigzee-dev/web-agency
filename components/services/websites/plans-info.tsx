...
export default function PlansInfo() {
  return (
    <div className="relative isolate max-w-6xl mx-auto py-20">
      ...
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 pt-5 flex items-center gap-2">
          <Select>
      ...
      <article className="w-full max-w-5xl mx-auto py-12 pt-24">
        <div className="w-full lg:grid lg:grid-cols-12 lg:gap-8 ">
          {/* Starter */}
          <div className="col-span-4 space-y-4 mb-8 lg:mb-0 border-l border-gray-400 pl-8">
            <div className="flex gap-0.5 w-36 h-36 radial-background rounded-full items-center justify-center">
              <h2 className="relative font-sans bg-gradient-to-r from-blue-500 via-cyan-500 to-indigo-400 text-transparent bg-clip-text text-2xl font-bold">
                Starter
                <p className="whitespace-nowrap  absolute left-1/2 -translate-x-1/2 top-full text-xs text-neutral-200/80">
                  One-Time
                </p>
              </h2>
            </div>
            ...
            {/* Suitable for */}
            <div className="mt-4">
              <h5 className="text-primary font-medium mb-0.5">Suitable for:</h5>
              <div className="grid grid-cols-1 space-y-1">
                {features.map((feature) => (
                  <li
                    key={feature}
                    className=" font-sans text-md text-gray-600 flex items-center gap-x-3"
                  >
                    <FaCheck
                      aria-hidden="true"
                      className={classNames(
                        "text-gray-600 h-auto w-2.5 flex-none"
                      )}
                    />
                    {feature}
                  </li>
          ...
          <div className="col-span-4 space-y-4 mb-8 lg:mb-0 border-l border-gray-400 pl-8">
            <div className="relative isolate flex flex-col gap-0.5 w-36 h-36 radial-secondary rounded-full items-center justify-center">
              <h2 className="relative font-sans text-white text-2xl font-bold">
                Business
                <p className="whitespace-nowrap font-sans font-light absolute left-1/2 -translate-x-1/2 top-full text-xs text-neutral-300">
                  One-Time
                </p>
              </h2>
          ...
          {/* <div className="col-span-7">
            ...
            <Button
              variant="default"
              className={` ${btnDimensions} bg-primary text-neutral-200  mt-8 `}
            >
              Read case study
            </Button>
