...
export const pageHeadings = ` ${montserrat.className} text-gray-900 text-[2.5rem] md:text-6xl font-bold glb-headings-lineheight text-center`;
export const pageHeadingsCenter = ` ${montserrat.className} text-gray-900 text-[2.5rem] md:text-6xl font-bold glb-headings-lineheight text-center whitespace-wrap`;
export const sectionHeadings = ` ${montserrat.className} text-gray-900 text-4xl md:text-5xl font-bold`;
export const longSectionHeadings = ` ${montserrat.className} text-gray-800 text-[2rem] leading-tight md:text-4xl font-bold text-balanced`;
