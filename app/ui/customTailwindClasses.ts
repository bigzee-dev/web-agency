...
export const btnDimensions =
  "text-center py-2.5 md:py-[0.52rem] px-3 w-max min-w-44 text-base md:text-base font-medium rounded-[0.65rem]";
...
export const whiteButton = ` ${btnDimensions} text-gray-800  bg-[#faf9f5] `;
