...
export const longSectionHeadings = ` ${montserrat.className} text-gray-800 text-3xl md:text-4xl font-bold`;
...
export const whiteButton = ` ${btnDimensions} bg-[#faf9f5]/95 font-medium`;
